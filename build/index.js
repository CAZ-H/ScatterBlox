...
if (container) {
  ...
  var sendReq = function sendReq(url, body, method, callback, errorCallback) {
  ...
  var getAssets = function getAssets(userId, assetType, callback, errorCallback) {
  ...
  var getAccessories = function getAccessories(assetTypes, callback) {
  ...
  var wearAssets = function wearAssets(list) {
    ...
    sendReq(url, body, 'POST', function () {
      location.reload();
    }, function (error) {
      console.log(error.stack);
    });
  ...
  var randomizeAvatar = function randomizeAvatar() {
    var bodyAssets = new Promise(function (resolve) {
      getAccessories(["Face", "Head", "Torso", "RightArm", "LeftArm", "RightLeg", "LeftLeg"], resolve);
    });
    var accessoryAssets = new Promise(function (resolve) {
    ...
    Promise.all([bodyAssets, accessoryAssets]).then(function (values) {
      var list = {
        assetIds: []
      }; // Select body parts
  ...
  _reactDom.default.render(Panel(), panelContainer);
